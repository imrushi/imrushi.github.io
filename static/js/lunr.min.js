  ...
  (F.version = "2.3.9"),
    ...
    (F.FieldRef.prototype.toString = function () {
      return (
        null == this._stringValue &&
          (this._stringValue =
            this.fieldName + F.FieldRef.joiner + this.docRef),
        this._stringValue
      );
    }),
    /*!
     ...
     */ (F.tokenizer = function (e, t) {
      ...
      if (Array.isArray(e))
        return e.map(function (e) {
          return new F.Token(
            F.utils.asString(e).toLowerCase(),
            F.utils.clone(t)
          );
        });
      for (
        ...
        if (r.charAt(s).match(F.tokenizer.separator) || s == i) {
          if (a > 0) {
            ...
            (u.position = [o, a]),
              (u.index = n.length),
              n.push(new F.Token(r.slice(o, s), u));
          }
          o = s + 1;
        }
      }
     ...
     */ (F.stemmer =
      ...
      (O = function (e) {
        ...
        if (
          ("y" == (s = e.substr(0, 1)) && (e = s.toUpperCase() + e.substr(1)),
          (a = p),
          (o = f).test(e)
            ? (e = e.replace(o, "$1$2"))
        ...
        return (
          ...
          (a = L),
          (o = E).test(e)
            ? ((i = (I = o.exec(e))[1]), (o = c).test(i) && (e = i))
            : a.test(e) &&
              ((i = (I = a.exec(e))[1] + I[2]), (a = c).test(i) && (e = i)),
          (o = b).test(e) &&
            ((i = (I = o.exec(e))[1]),
            (a = h),
            (u = T),
            ((o = c).test(i) || (a.test(i) && !u.test(i))) && (e = i)),
          (a = c),
          (o = P).test(e) && a.test(e) && ((o = g), (e = e.replace(o, ""))),
          "y" == s && (e = s.toLowerCase() + e.substr(1)),
          e
        );
      }),
      function (e) {
    ...
    (F.TokenSet.fromArray = function (e) {
      for (var t = new F.TokenSet.Builder(), r = 0, i = e.length; r < i; r++)
        t.insert(e[r]);
    ...
    (F.TokenSet.fromFuzzyString = function (e, t) {
      for (
        var r = new F.TokenSet(), i = [{ node: r, editsRemaining: t, str: e }];
        i.length;
        ...
        if (n.str.length > 0) {
          ...
          o in n.node.edges
            ? (s = n.node.edges[o])
            : ((s = new F.TokenSet()), (n.node.edges[o] = s)),
        ...
        if (0 != n.editsRemaining) {
          ...
          if (n.str.length > 1) {
            ...
            h in n.node.edges
              ? (l = n.node.edges[h])
              : ((l = new F.TokenSet()), (n.node.edges[h] = l)),
          ...
          for (var l = n[u], c = 0; c < a; c++) {
            ...
            if (h == l || "*" == l) {
              ...
              h in r.output.edges
                ...
                : (((y = new F.TokenSet()).final = p), (r.output.edges[h] = y)),
          ...
          for (var m = 0; m < p.length; m++) {
            ...
            for (y = 0; y < u.fields.length; y++) {
              var w = x[(R = u.fields[y])],
                ...
                S = new F.Set(Q);
              if (
                (u.presence == F.Query.presence.REQUIRED &&
                  ((c = c.union(S)),
                  void 0 === s[R] && (s[R] = F.Set.complete)),
                u.presence != F.Query.presence.PROHIBITED)
              ) {
                if (
                  ...
                  for (var E = 0; E < Q.length; E++) {
                    var L,
                      ...
                      T = w[b];
                    void 0 === (L = r[P])
                      ? (r[P] = new F.MatchData(g, R, T))
                      : L.add(g, R, T);
                  }
                  n[k] = !0;
                }
              } else
                void 0 === o[R] && (o[R] = F.Set.empty), (o[R] = o[R].union(S));
            }
          }
        }
    ...
    (F.Builder.prototype.createFieldVectors = function () {
      for (
        ...
        for (
          var s = F.FieldRef.fromString(t[n]),
            o = s.fieldName,
          ...
          void 0 === i[x]
            ? ((y = F.idf(this.invertedIndex[x], this.documentCount)),
              (i[x] = y))
            : (y = i[x]),
            (m =
              (y * ((this._k1 + 1) * v)) /
    ...
    (F.Builder.prototype.createTokenSet = function () {
      this.tokenSet = F.TokenSet.fromArray(
    ...
    (F.QueryLexer.lexField = function (e) {
      return (
        e.backup(), e.emit(F.QueryLexer.FIELD), e.ignore(), F.QueryLexer.lexText
      );
    }),
    (F.QueryLexer.lexTerm = function (e) {
      if (
        (e.width() > 1 && (e.backup(), e.emit(F.QueryLexer.TERM)),
        e.ignore(),
        e.more())
      )
